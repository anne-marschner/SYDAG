...
const Step2_ModeForm = ({
    ...
    // Handler function when the mode changes.
    const handleValueChange = (newModeSelected: string) => {
        if (newModeSelected) {
            ...
            // Reset file error if changing modes
            if (isManualMode) {
                setFileError(null);
            }

            // Update central form data with the new mode and conditional fields.
            updateForm({
    ...
    // Handler for when the user selects a JSON file.
                ...
                reader.onload = async (event) => {
                    try {
                        ...
                        if (typeof text === "string") {
                            ...
                            // Validate jsonData matches FormItemsJSONSchema
                            const parsedData = await FormItemsJSONSchema.parseAsync(jsonData);

                            // Update the form data with parsedData
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div className="relative -top-1 flex flex-col items-start md:top-0">
                        ...
                        <p className="text-sm">Set configuration automatically</p>
                    </div>
                </ToggleGroup.Item>
                ...
                >
                    ...
                    <div className="relative -top-1 flex flex-col items-start md:top-0">
                        ...
                        <p className="text-sm">Set configuration manually</p>
                    </div>
                </ToggleGroup.Item>
            </ToggleGroup.Root>
            ...
            {modeSelected === "UploadJson" && (
                <div className="w-full flex flex-col bg-neutral-900 p-3 rounded-md mt-4">
                    ...
                    <a
                        href="resources/template.json"  // Accesses it from the public directory
